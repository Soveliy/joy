...
/* harmony import */ var fslightbox__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! fslightbox */ "./node_modules/fslightbox/index.js");
...
window.addEventListener('load', () => {
  ...
  if (swiperContacts) {
    const swiperContactsSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](swiperContacts, {
      spaceBetween: 25,
      navigation: {
        nextEl: ".swiper-button-next",
        prevEl: ".swiper-button-prev"
  ...
  if (reviewsSlider) {
    resizableSwiper('(min-width: 1024px)', '.reviews__slider--js', {
      slidesPerView: '3',
      spaceBetween: 25,
      pagination: {
